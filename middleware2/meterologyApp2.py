...
def addME():
    ...
    "pub_name":"seaLevel",
    "brokerAddress": "http://localhost:5002/"
    }]
    res0 = requests.post('http://middleware:5000/api/addBroker',json.dumps(myRecord))
    if not res0:
        return "Failed"
    else:
